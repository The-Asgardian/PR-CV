...
scatter3(X_disp(labels==1,1), X_disp(labels==1,2), X_disp(labels==1,3), 'r', 'filled'); hold on;
scatter3(X_disp(labels==2,1), X_disp(labels==2,2), X_disp(labels==2,3), 'g', 'filled');
scatter3(X_disp(labels==3,1), X_disp(labels==3,2), X_disp(labels==3,3), 'b', 'filled');
...
idx_euclid = kmeans(X_disp, 3, 'Replicates', 5);
...
for m = 1:3 % Real Materials
    for c = 1:3 % K-means Clusters
        ...
        if any(mask)
            scatter3(X_disp(mask,1), X_disp(mask,2), X_disp(mask,3), ...
...
idx_city = kmeans(X_disp, 3, 'Distance', 'cityblock', 'Replicates', 5);
